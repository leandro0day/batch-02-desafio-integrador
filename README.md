...
1. Pega aquí la tx de una compra de un NFT `común` en `Public Sale` usando `UDSC`: 0x164d4909a87cff8c633695de16731228adbe0f0a5486cadbe437564b4ea2af12
2. Pega aquí la tx de una compra de un NFT `raro` en `Public Sale` usando `BBTKN`: 0x0e34cb6a21352f02f36f8417d911de99e42ffa9fbd2d920f71e610515211ab22
3. Pega aquí la tx de una compra de un NFT `legendario` en `Public Sale` usando `UDSC`: 0x8813c8cf7c7c1f3726b89b15f9d432477b3dfcfe7fc52f1540754624324a913a
4. Pega aquí la tx de una compra de un NFT `mistico` en `Public Sale` usando `ether` y un `id` en específico: 0x0f615e5730a23fa42059f7c375a8bd2470d7ab3505d1940f25c34876d33709ca
5. Pega aquí la tx de una compra de un NFT `mistico` en `Public Sale` usando `ether` (random id):0x0e06c44191121b15139b43d889edffb1e22fb76adabb6e920ef2261b4211a03a
6. Pega aquí la tx de una acuñación whitelist de un NFT en el contrato `NFT`: 0x16e71b927c9f5a40ae8010ff5d20ed0bf59f3d8ab433466d3a12444caf1ce35c
7. Pega aquí la tx de un buy back de NFT en el contrato `NFT`: 0xff03937962c619c21d83d4ad1fee2321bf1ce96bdb78647894f7615693bdacbd
